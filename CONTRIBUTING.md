...
- [Implement a #starter feature](http://github.com/mongodb-js/mongorc/labels/starter)
- Add an example to `README.md`

## Workflow

1. [Fork the repository on GitHub](http://github.com/mongodb-js/mongorc)
...
[creating a new issue](http://github.com/mongodb-js/mongorc/issues).
